    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="/picturesform/login2.jpg" alt="login" class="login-card-img">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              <div class="brand-wrapper">
                <img src="/picturesform/sup.png" alt="logo" class="logo">
              </div>
              <div class="results">
                @if(Session::get('fail'))
    ...
    <form method="post" action="/posts/check">
        @csrf
                <div class="form-group">
                    ...
                    <input type="text" name="matricule" id="email" class="form-control" placeholder="Matricule">
                  </div>
