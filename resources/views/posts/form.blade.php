    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center" >
          <h2 style="color: orange">Le moment tant attendu est <span>enfin arrivé</span></h2>
          <h2 style="color: orange">Celui de choisir un président au poste de LEADER MANAGER.</h2>
...
<br>
  <div class="text-center">
   <button type="submit" class="text-center d-block btn btn-danger">Valider votre vote</button>
  </div>
</form>
