...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
       <a href="" class="logo"><b>SUP<span>'MANAGEMENT</span></b></a>
      <!--logo end-->
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="index.html#">
                  <span class="photo"><img alt="avatar" src="temps/img/ui-zac.jpg"></span>
                  <span class="subject">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="blank.html">Mohamed Junior Nimaga</a></li>
              <li><a href="login.html">Moussa KABA</a></li>
              <li><a href="lock_screen.html">Oumou Keita</a></li>
              <li><a href="profile.html">Abdoubacar Goundourou</a></li>
              <li><a href="invoice.html">Diata Traoré</a></li>
              <li><a href="pricing_table.html">Oumar Fofana</a></li>
              <li><a href="faq.html">Luciane Inisse Dolo</a></li>
